...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug  9 14:33:14 2020
...
def summary():
    with open("./data/comsum_corpus/comsum_2.23.csv", "r") as infile:
        ...
        tree =  ET.parse("./data/SUM_2005_corpus/2002May23burket-1.ling.xml")
        root = tree.getroot()
