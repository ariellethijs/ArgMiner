...
class tfidf_calc:
    def __init__(self):
        ...
        #self.case_ids = []
        '''
        with open("./data/complete_sum.csv", "r") as infile:
        ...
        '''
        self.case_ids = ['1.19', '1.63', '1.68', 'NA', '1.05', '1.02', '1.04', '1.35', '1.39',
        '1.38', '1.42', '1.34', '1.11', '1.15', '1.26', '1.28', '1.57', '1.43', '1.55',
        '2.13', '2.18', '2.3',  '2.35', '2.34', '2.26', '2.24', '2.29', '2.21', '2.23',
